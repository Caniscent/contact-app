    ...
    <div class="bg-white shadow rounded-lg p-6 sm:p-8 lg:p-10 w-full max-w-md">
        ...
        <form action="{{ route('contact.edit', $contact->id) }}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="address" value="{{$contact->address}}" name="address" id="address" class="mt-1 block w-full px-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan email">
            </div>
